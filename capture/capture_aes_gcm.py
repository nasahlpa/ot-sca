        ...
        while remaining_num_traces > 0:
            ...
            if capture_cfg.capture_mode == "aes_gcm_fvsr_batch":
                ...
                ot_aes_gcm.fvsr_batch(capture_cfg.num_segments, capture_cfg.triggers,
                                      capture_cfg.trigger_block, capture_cfg.iv_fixed[0:12],
                                      capture_cfg.iv_len_bytes, capture_cfg.key_fixed,
                                      capture_cfg.key_len_bytes, capture_cfg.aad_blocks,
...
def main(argv=None):
    ...
    capture_cfg = CaptureConfig(capture_mode = mode,
                                ...
                                iv_len_bytes = cfg["test"]["iv_len_bytes"],
